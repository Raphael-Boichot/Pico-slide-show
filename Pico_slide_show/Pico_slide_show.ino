...
void setup(void) {
  ...
  img.createSprite(128, 112);  // then create the giant sprite that will be an image of our video ram buffer
...
{
  graphical_DATA_offset = getRandom(images) * tile_packet_size - 1;  //starting offset to get tile data
                                                                     //step 1 buffering the data
